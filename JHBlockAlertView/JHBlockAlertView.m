...
+ (instancetype)alertViewWithTitle:(NSString *)title message:(NSString *)message cancelButtonItem:(JHBlockAlertViewItem *)cancelItem otherButtonItems:(JHBlockAlertViewItem *)otherItems, ...
{
    JHBlockAlertView *alertView = [[JHBlockAlertView alloc] initAlertViewWithTitle:title message:message cancelButtonItem:cancelItem otherButtonItems: nil];
